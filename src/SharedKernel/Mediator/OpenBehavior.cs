...
public class OpenBehavior
{
    ...
    /// <param name="serviceLifetime">The lifetime of the registered service. Defaults to Scoped.</param>
    ...
    public OpenBehavior(Type openBehaviorType, ServiceLifetime serviceLifetime = ServiceLifetime.Scoped)
    {
